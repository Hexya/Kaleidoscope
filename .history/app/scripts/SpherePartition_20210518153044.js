...
import uvovo from '../assets/img/uvv.jpeg';
...
export default class App {
    ...
    constructor() {
        ...
        var texture2 = textureLoader.load(uvovo);
        ...
        document.querySelector('.img').addEventListener('change', (event) => {
            ...
            reader.addEventListener('load', (event) => {
                ...
                let textureA = textureLoader.load(output);
                this.plane.material = new THREE.MeshBasicMaterial({map: textureA});
            });
        ...
        document.querySelector('.img2').addEventListener('change', (event) => {
            ...
            reader.addEventListener('load', (event) => {
                output = event.target.result;
                let textureB = textureLoader.load(output);
                this.plane2.material = new THREE.MeshBasicMaterial({map: textureB});
            });
            reader.readAsDataURL(file);
        }); 
    }
