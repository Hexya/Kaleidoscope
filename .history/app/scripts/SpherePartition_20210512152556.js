...
export default class App {
    ...
    constructor() {
        ...
        this.rayon = .9;
            ...
            gui.add( params, 'posx', 0.1, 20 ).onChange( function ( value ) {
                this.camera.position.x = Number( value );
            } );
        ...
        this.camera.position.x = params.posx;
        this.camera.position.y = 0.3;
        this.camera.position.z = Math.pow(1.7, -17);
        // this.camera.rotation.x = Math.pow(1.7, -17);
