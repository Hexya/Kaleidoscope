...
export default class App {
    ...
    constructor() {
        ...
        //LIGHT
            //Directional
            this.light = new THREE.AmbiantLight({color: 0x0000ff,intensity : 1})
        ...
        //BACK PLANE
        this.pGeometry = new THREE.PlaneBufferGeometry(  window.innerWidth/10, window.innerHeight, 10 );
        ...
        let textureLoader = new THREE.TextureLoader();
        let textureNormal = textureLoader.load('https://i.imgur.com/CslEXIS.jpg');
        ...
        const size = this.getPerspectiveSize(this.camera, this.camera.position.z); //Camera coord
        let reScale = (size.width / (Math.abs(currentBox3.max.x) + Math.abs(currentBox3.min.x)));
