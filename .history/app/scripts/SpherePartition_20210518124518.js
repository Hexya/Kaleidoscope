...
export default class App {
    ...
    constructor() {
        ...
        document.querySelector('#main').addEventListener( 'mousemove', (kaleidoPass)=> {
            let mouseX = (( event.clientX / window.innerWidth ) * 2 - 1)*12;
            let mouseY = - ( event.clientY / window.innerHeight ) * 2 + 1;
            // console.log(mouseX)
            kaleidoPass.uniforms[ "sides" ].value = let mouseX
        } );
    }
