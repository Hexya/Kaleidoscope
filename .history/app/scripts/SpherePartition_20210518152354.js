...
export default class App {
    ...
    constructor() {
        ...
        this.pMaterial2 = new THREE.MeshBasicMaterial({map: texture,transparent:true})
        ...
        document.querySelector('#main').addEventListener( 'mousemove', (e)=> {
            ...
            this.plane2.material.opacity = 0.5
        ...
        document.querySelector('.img').addEventListener('change', (event) => {
            ...
            reader.addEventListener('load', (event) => {
                ...
                let texture2 = textureLoader.load(output);
                this.plane.material = new THREE.MeshBasicMaterial({map: texture2});
            });
